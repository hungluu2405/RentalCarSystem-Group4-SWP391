...
<%-- NHÚNG PHẦN HEAD VÀ HEADER CHUNG (Đường dẫn tuyệt đối) --%>
<%@ include file="/view/common/customer/_head_and_top_header.jsp" %>
    ...
    <section id="section-cars" class="bg-gray-100">
        <div class="container">
            <div class="row">
                ...
                <%-- NHÚNG SIDEBAR RIÊNG CỦA KHÁCH HÀNG (Đường dẫn tuyệt đối) --%>
                <%@ include file="/view/common/customer/_customer_sidebar.jsp" %>
...
<%-- NHÚNG PHẦN FOOTER VÀ SCRIPTS CHUNG (Đường dẫn tuyệt đối) --%>
<%@ include file="/view/common/customer/_footer_and_scripts.jsp" %>