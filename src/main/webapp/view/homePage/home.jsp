...
<!-- Mirrored from www.madebydesignesia.com/themes/rentaly/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Sep 2025 10:55:29 GMT -->
<head>
    ...
    <div class="no-bottom no-top" id="content">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 offset-lg-3 text-center">
                        <span class="subtitle">Why Choose Us</h2></span>
                        <h2>Our Features</h2>
        ...
        <section id="section-cars">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 offset-lg-3 text-center">
                        <span class="subtitle">Enjoy Your Ride</h2></span>
        ...
        <section id="section-news">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 offset-lg-3 text-center">
                        <span class="subtitle">Latest From Us</h2></span>
                        <h2>News &amp; Promo</h2>
