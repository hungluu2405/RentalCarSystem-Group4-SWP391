                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:when test="${sessionScope.user.roleId == 1}">
                                                                <a class="menu-item"
                                                                   ...
                                                                   role="menuitem">Tài khoản Admin</a>
                                                            </c:when>
                                ...
                                <div class="item_filter_group">
                                    ...
                                    <div class="p-3" data-bgcolor="#f5f5f5" style="border-radius: 5px;">
                                        <form action="${pageContext.request.contextPath}/cars" method="get">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label">Giá tối đa (VND/ngày)</label>
                                                <input type="number" name="price" class="form-control"
                                                       value="${param.price != null ? param.price : requestScope.price}"
                                                       min="0">
                                            </div>

                                            <button type="submit" class="btn-main w-100">Áp dụng bộ lọc</button>
                                        </form>
                                                ...
                                                <div class="d-info">
                                                    <div class="d-text">
                                                        ...
                                                        <div class="row g-2 my-3">
                                                            <div class="col-6">
                                                                <i class="fa fa-users text-muted me-2"></i>${car.capacity} Ghế
                                                            </div>
                                                            <div class="col-6">
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div>
                                                                <span class="fs-6 text-muted">Giá từ</span>
                                ...
                                <nav aria-label="Page navigation" class="mt-4">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                            <a class="page-link" href="?page=1${extraParams}" aria-label="Trang đầu">«</a>
                                        </li>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                ...
                                                <c:if test="${start > 1}">
                                                    <li class="page-item">
                                                        <a class="page-link" href="?page=1${extraParams}">1</a>
                                                    </li>
                                                ...
                                                <c:if test="${end < totalPages}">
                                                    <li class="page-item disabled"><span class="page-link">...</span></li>
                                                    <li class="page-item">
                                                        <a class="page-link" href="?page=${totalPages}${extraParams}">${totalPages}</a>
                                                    </li>
                                                </c:if>
                                            </c:otherwise>
                                        </c:choose>
                                        ...
                                        <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                                            <a class="page-link" href="?page=${totalPages}${extraParams}" aria-label="Trang cuối">»</a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="d-flex justify-content-center mt-2">
                                        <form method="get" class="d-flex align-items-center">
                                            <c:forEach var="param" items="${paramMap}">
                                            ...
                                            <input type="number" name="page" min="1" max="${totalPages}"
                                                   ...
                                                   style="width: 80px;">
                                            <button type="submit" class="btn btn-outline-primary btn-sm ms-2">Đi đến</button>
                                        </form>
                                    </div>
                                </nav>
