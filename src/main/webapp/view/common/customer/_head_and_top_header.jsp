<%-- _head_and_top_header.jsp --%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html lang="zxx">

<head>
    <title>Rentaly - Customer Dashboard</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Rentaly - Multipurpose Vehicle Car Rental Website Template">
    <meta name="keywords" content="">
    <meta name="author" content="">

    <link rel="icon" href="${pageContext.request.contextPath}/images/icon.png" type="image/png" sizes="16x16">
                    ...
                    <div class="de-flex sm-pt10">
                        ...
                        <div class="de-flex-col header-col-mid">
                            <ul id="mainmenu">
                                ...
                                <li><a class="menu-item" href="customerDashboard.jsp">My Account</a>
                                    <ul>
                                        <li><a class="menu-item" href="customerDashboard.jsp">Dashboard</a></li>
                            ...
                            <div class="menu_side_area">
                                <div class="de-login-menu">
                                    ...
                                    <div id="de-submenu-profile" class="de-submenu">
                                        ...
                                        <ul class="menu-col">
                                            <li><a href="customerDashboard.jsp"><i class="fa fa-home"></i>Dashboard</a></li>
