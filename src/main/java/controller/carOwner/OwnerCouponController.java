...
@WebServlet("/owner/myCoupon")
public class OwnerCouponController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/view/carOwner/myCoupon.jsp").forward(request, response);
